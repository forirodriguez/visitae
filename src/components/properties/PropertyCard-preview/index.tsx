...
interface PropertyCardProps {
  property: Property;
  // Para compatibilidad, hacemos este prop opcional
  onClick?: () => void;
}
...
export default function PropertyCard({ property, onClick }: PropertyCardProps) {
  ...
  const cardContent = (
    <div className="group relative bg-white dark:bg-gray-800 rounded-xl overflow-hidden border shadow-sm transition-all duration-300 hover:shadow-md h-full flex flex-col">
      {/* Imagen */}
  ...
  // Si hay un onClick, devolver el div directamente, de lo contrario, envolverlo en un div normal
  return (
